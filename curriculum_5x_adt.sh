...
for ((i = 0; i < length; i++)); do
    ...
    torchrun --master_port=12132 --nproc_per_node 8 train.py --scale medium_5x --data_dir $datapath --output_dir /home/pratyus2/logs/ --exp_name $exp_name --filter none --workers 10 --num_saves_per_epoch 10 --num_checkpoints $epoch --curriculum 1 --resume latest --train_num_samples $train_num_samples --total_steps 157
    # move all the checkpoints to a folder stepwise if they have the term "step"
    mv /home/pratyus2/logs/$exp_name/checkpoints/*step* /home/pratyus2/logs/$exp_name/intermediate/
done