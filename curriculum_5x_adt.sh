...
for ((i = 0; i < length; i++)); do
    ...
    torchrun --master_port=12132 --nproc_per_node 8 train.py --scale medium_5x --data_dir $datapath --output_dir /home/pratyus2/logs/ --exp_name $exp_name --filter none --workers 10 --num_saves_per_epoch 1 --num_checkpoints 50 --curriculum 1 --resume latest --curriculum_epoch $epochs
