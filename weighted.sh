...
torchrun --master_port=12232 --nproc_per_node 8 train.py --scale medium --data_dir $datapath --output_dir /home/pratyus2/logs/ --exp_name $exp_name --filter none --workers 10 --num_saves_per_epoch 2 --num_checkpoints 10 --data_weights $weights