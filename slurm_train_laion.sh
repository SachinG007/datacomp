...
# Change these!
#SBATCH --job-name=small_scale_laion_filter_5x
#SBATCH --nodes 1
...
#SBATCH --output=slurm_logs/small_scale_laion_filter_5x.out
#SBATCH --error=slurm_logs/small_scale_laion_filter_5x.err
#SBATCH --requeue
...
DATA_PATH="/project_data/datasets/datanet/small_scale/shards_laion2b_filter/"
SCALE="small_5x"
SEED=0
OUTPUT_DIR="/project_data2/projects/sachingo/datacomp_checkpoints/logs/"
NUM_CHECKPOINTS=5
EXP_NAME="smallscale_laion_filter_5x_$(date +%Y%m%d_%H%M%S)"
